//
//  TWGNotificationObserverTests.m
//  TWGExtensions
//
...
- (void)
    testinitWithNotificationNameSetsNotificationCenterAsDefaultCenterIfNotificationParamIsNil {
  self.notificationObserver =
      [[TWGNotificationObserver alloc] initWithNotificationName:OCMOCK_ANY
                                                      fireBlock:nil];
  expect(self.notificationObserver.notificationCenter)
      .to.equal([NSNotificationCenter defaultCenter]);
}

- (void)testinitWithNotificationNameSetsNotificationNamesArray {
  self.notificationObserver =
      [[TWGNotificationObserver alloc] initWithNotificationName:@"someNoti"
                                                      fireBlock:nil];
  expect(self.notificationObserver.notificationNames)
      .to.equal(@[ @"someNoti" ]);
}
...
- (void)testinitWithNotificationNamesSetsNotificationNamesArray {
  ...
  self.notificationObserver =
      [[TWGNotificationObserver alloc] initWithNotificationNames:someArray
                                                       fireBlock:nil];
...
- (void)
    testInitWithNotificationNamesRegistersObserversAndObserverCallsTriggerFireBlockWithNotification {
  ...
  [[NSNotificationCenter defaultCenter] postNotificationName:notificationName
                                                    ...
                                                    userInfo:OCMOCK_ANY];
  OCMVerify(
      [mockNotificationObserver triggerFireBlockWithNotification:OCMOCK_ANY]);
}
